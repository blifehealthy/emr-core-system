...
import { getPrinterBridgeHealthReport } from '../backend/services/getPrinterBridgeHealthReport.ts';
import { getControlledSubstanceRegister } from '../backend/services/getControlledSubstanceRegister.ts';
...
} from '../backend/services/inventoryLocations.ts';
import {
  listInventoryLots,
  receiveInventoryLot,
...
} from '../backend/services/inventoryBarcodeLabelTemplates.ts';
import {
...
} from '../backend/services/inventoryBarcodePrintJobs.ts';
import {
  createInventoryPrinterProfile,
  listInventoryPrinterProfiles,
  updateInventoryPrinterProfile,
} from '../backend/services/inventoryPrinterProfiles.ts';
import {
  createPurchaseOrder,
  createPurchaseOrderApprovalPolicy,
  approvePurchaseOrder,
  listPurchaseOrderApprovalPolicies,
  listPurchaseOrders,
  rejectPurchaseOrder,
...
const server = createNodeServer({
  ...
  getPrinterBridgeHealthReport: getPrinterBridgeHealthReport(db),
  getControlledSubstanceRegister: getControlledSubstanceRegister(db),
  ...
  listInventoryLocations: listInventoryLocations(db),
  createInventoryLocation: createInventoryLocation(db),
  updateInventoryLocation: updateInventoryLocation(db),
  ...
  createInventoryBarcodePrintJob: createInventoryBarcodePrintJob(db),
  listInventoryBarcodeLabelTemplates: listInventoryBarcodeLabelTemplates(db),
  createInventoryBarcodeLabelTemplate: createInventoryBarcodeLabelTemplate(db),
  updateInventoryBarcodeLabelTemplate: updateInventoryBarcodeLabelTemplate(db),
  listInventoryBarcodePrintJobs: listInventoryBarcodePrintJobs(db),
  updateInventoryBarcodePrintJobDelivery: updateInventoryBarcodePrintJobDelivery(db),
  fallbackInventoryBarcodePrintJob: fallbackInventoryBarcodePrintJob(db),
  retryInventoryBarcodePrintJob: retryInventoryBarcodePrintJob(db),
  listInventoryPrinterProfiles: listInventoryPrinterProfiles(db),
  createInventoryPrinterProfile: createInventoryPrinterProfile(db),
  updateInventoryPrinterProfile: updateInventoryPrinterProfile(db),
  ...
  listPurchaseOrderApprovalPolicies: listPurchaseOrderApprovalPolicies(db),
  createPurchaseOrderApprovalPolicy: createPurchaseOrderApprovalPolicy(db),
  updatePurchaseOrderApprovalPolicy: updatePurchaseOrderApprovalPolicy(db),
