...
- มี browser smoke test แบบ headless Chrome สำหรับ flow คิวตรวจ พิมพ์ใบสั่งยา check-in จากนัดหมาย และแก้ SOAP แล้ว รวมถึงชุดที่ยิงผ่าน API จริงกับฐานข้อมูลทดสอบ แต่ยังไม่ใช่ Playwright suite เต็มรูปแบบ
