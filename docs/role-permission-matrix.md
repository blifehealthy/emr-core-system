...
| `GET` | `/api/reports/daily-operations.csv` | `audit_read` |
| `GET` | `/api/reports/pharmacy-overrides` | `audit_read` |
| `GET` | `/api/reports/pharmacy-overrides.csv` | `audit_read` |
| `GET` | `/api/reports/printer-bridge-health` | `audit_read` |
| `GET` | `/api/reports/printer-bridge-health.csv` | `audit_read` |
...
| `PATCH` | `/api/controlled-substance-reconciliations/:reconciliationId/approve` | `drug_catalog_write` |
...
| `GET` | `/api/inventory-locations` | `drug_catalog_read` |
| `POST` | `/api/inventory-locations` | `drug_catalog_write` |
...
| `PATCH` | `/api/inventory-barcode-print-jobs/:jobId/fallback` | `drug_catalog_write` |
| `PATCH` | `/api/inventory-barcode-print-jobs/:jobId/retry` | `drug_catalog_write` |
| `GET` | `/api/inventory-barcode-label-templates` | `drug_catalog_read` |
| `POST` | `/api/inventory-barcode-label-templates` | `drug_catalog_write` |
| `PATCH` | `/api/inventory-barcode-label-templates/:templateId` | `drug_catalog_write` |
...
| `POST` | `/api/purchase-orders/:purchaseOrderId/submit` | `drug_catalog_write` |
| `POST` | `/api/purchase-orders/:purchaseOrderId/approve` | `drug_catalog_write` |
| `POST` | `/api/purchase-orders/:purchaseOrderId/reject` | `drug_catalog_write` |
| `POST` | `/api/purchase-orders/:purchaseOrderId/receive` | `drug_catalog_write` |
| `GET` | `/api/purchase-order-approval-policies` | `drug_catalog_read` |
| `POST` | `/api/purchase-order-approval-policies` | `drug_catalog_write` |
| `PATCH` | `/api/purchase-order-approval-policies/:policyId` | `drug_catalog_write` |
...
| `GET` | `/api/file-assets/storage-policy` | `attachment_read` |
